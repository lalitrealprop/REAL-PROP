  ...
  useEffect(() => {
    ...
    homeButtonStyle.textContent = `
      ...
      @media (max-width: 992px) {
        .crc-peridona-root .realprop-home-link { padding: 8px 12px; font-size: 11px; margin-right: 8px; }
      }
      @media (max-width: 767px) {
        .crc-peridona-root .nav-btn .realprop-home-link {
          position: absolute; left: 18px; top: 50%; transform: translateY(-50%); z-index: 1002;
          padding: 7px 10px; font-size: 9px; letter-spacing: 0.25px; margin: 0;
        }
      }
    `;
